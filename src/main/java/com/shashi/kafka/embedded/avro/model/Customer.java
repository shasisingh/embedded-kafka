 ...
 */
package com.shashi.kafka.embedded.avro.model;
...
public class Customer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5856240135740396124L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Customer\",\"namespace\":\"com.shashi.kafka.embedded.avro.model\",\"fields\":[{\"name\":\"customerName\",\"type\":\"string\"},{\"name\":\"address\",\"type\":\"string\"},{\"name\":\"pinCode\",\"type\":\"int\"}]}");
   ...
   */
  public static com.shashi.kafka.embedded.avro.model.Customer.Builder newBuilder() {
    return new com.shashi.kafka.embedded.avro.model.Customer.Builder();
  }
   ...
   * @return A new Customer RecordBuilder
   */
  public static com.shashi.kafka.embedded.avro.model.Customer.Builder newBuilder(com.shashi.kafka.embedded.avro.model.Customer.Builder other) {
    if (other == null) {
      return new com.shashi.kafka.embedded.avro.model.Customer.Builder();
    } else {
      return new com.shashi.kafka.embedded.avro.model.Customer.Builder(other);
    }
  }
   ...
   * @return A new Customer RecordBuilder
   */
  public static com.shashi.kafka.embedded.avro.model.Customer.Builder newBuilder(com.shashi.kafka.embedded.avro.model.Customer other) {
    if (other == null) {
      return new com.shashi.kafka.embedded.avro.model.Customer.Builder();
    } else {
      return new com.shashi.kafka.embedded.avro.model.Customer.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Customer>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.shashi.kafka.embedded.avro.model.Customer.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.shashi.kafka.embedded.avro.model.Customer other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.customerName)) {
        this.customerName = data().deepCopy(fields()[0].schema(), other.customerName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.shashi.kafka.embedded.avro.model.Customer.Builder setCustomerName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.shashi.kafka.embedded.avro.model.Customer.Builder clearCustomerName() {
      customerName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.shashi.kafka.embedded.avro.model.Customer.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.shashi.kafka.embedded.avro.model.Customer.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.shashi.kafka.embedded.avro.model.Customer.Builder setPinCode(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.shashi.kafka.embedded.avro.model.Customer.Builder clearPinCode() {
